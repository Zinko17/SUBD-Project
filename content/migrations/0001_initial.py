# Generated by Django 5.0.11 on 2025-01-25 09:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('positionid', models.ForeignKey(db_column='PositionID', on_delete=django.db.models.deletion.DO_NOTHING, to='content.positions')),
            ],
            options={
                'db_table': 'Employees',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('employeeid', models.ForeignKey(db_column='EmployeeID', on_delete=django.db.models.deletion.DO_NOTHING, to='content.employees')),
                ('productid', models.ForeignKey(db_column='ProductID', on_delete=django.db.models.deletion.DO_NOTHING, to='content.finishedgoods')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('employeeid', models.ForeignKey(db_column='EmployeeID', on_delete=django.db.models.deletion.DO_NOTHING, to='content.employees')),
                ('rawmaterialid', models.ForeignKey(db_column='RawMaterialID', on_delete=django.db.models.deletion.DO_NOTHING, to='content.rawmaterials')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='unitid',
            field=models.ForeignKey(db_column='UnitID', on_delete=django.db.models.deletion.DO_NOTHING, to='content.units'),
        ),
        migrations.AddField(
